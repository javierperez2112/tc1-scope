...
class TC1ScopeApp:
    def __init__(self, root):
        ...
        self.scl_tcursor1 = tk.Scale(master=self.frm_grid, from_=0, to=1, resolution=0.001, orient=tk.HORIZONTAL, length=200, showvalue=0)
        self.scl_tcursor1.config(command=self.update_channels)
        self.scl_tcursor2 = tk.Scale(master=self.frm_grid, from_=0, to=1, resolution=0.001, orient=tk.HORIZONTAL, length=200, showvalue=0)
    ...
    def create_channels(self, n_channels):
        ...
        for i in range(n_channels):
            ...
            spb_cursor1 = tk.Scale(master=panel, from_=0, to=1, resolution=0.001, orient=tk.HORIZONTAL, length=200, showvalue=0)
            spb_cursor1.config(command=self.update_channels)
            #spb_cursor1.delete(0,tk.END)
            #spb_cursor1.insert(0,0.0)
            spb_cursor2 = tk.Scale(master=panel, from_=0, to=1, resolution=0.001, orient=tk.HORIZONTAL, length=200, showvalue=0)
